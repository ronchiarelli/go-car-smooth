  ...
  return (
    <section className="relative py-10">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-primary px-6 py-10 text-primary-foreground md:px-12">
          <div className="grid items-center gap-6 md:grid-cols-2">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.3em] text-white/80">— Car Brands —</p>
              <h3 className="mt-2 font-display text-4xl md:text-5xl">Explore Our Premium Brands</h3>
              <Link
                to="/cars"
