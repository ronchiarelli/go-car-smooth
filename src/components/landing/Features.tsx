...
import featureCar from "@/assets/fleet-suv.jpg";

const FEATURES = [
  { icon: CarFront, title: "Deals For Every Budget", body: "Incredible prices on every car, van and package. Book your ride at a price you actually like." },
    ...
    <section className="bg-background py-10 sm:py-16">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 md:px-8 lg:grid-cols-2">
        ...
        <div className="relative">
          ...
          <img src={featureCar} alt="Premium SUV" loading="lazy" className="relative z-10 mx-auto w-full max-w-md rounded-3xl object-cover" />
        </div>
      </div>
    </section>
  );
