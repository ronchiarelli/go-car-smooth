  ...
  return (
    <section className="py-10">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="flex flex-col items-center justify-between gap-6 rounded-3xl border border-border bg-muted px-8 py-10 md:flex-row">
          <div>
            <p className="text-sm font-bold uppercase tracking-wider text-primary">Need any help?</p>
            <p className="mt-1 font-display text-3xl md:text-4xl">+1 202 102 2124</p>
          </div>
          <a
